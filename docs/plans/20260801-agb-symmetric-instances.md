...
- **Repo**: `/home/user/agbridge-public`, `main`, HEAD `5571337` (⚠️ R6 — two commits since R5 added `agb-ralphex` and `agb-host-line`; `agb`, `agb_mac`, `agb-refresh` and the tests are untouched, so no cited line moved). No worktree. 1798 tests, ~52 s.
  VERSION 0.5.0.
