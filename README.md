...
```sh
python3 -m pytest tests/ -q          # 1769 tests, no network, no second host, no Mac required
...
**Running end to end against a live agterm**, across two Linux hosts and a Mac. 1769 tests, no
